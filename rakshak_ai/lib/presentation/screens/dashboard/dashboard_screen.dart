...
class _DashboardScreenState extends ConsumerState<DashboardScreen>
  ...
  Widget _buildStressInsight(
      ...
      {bool mlEnhanced = false}) {
    final msg = switch (riskLevel) {
      'high' => '⚠️ High stress ($score/100). Consider relaxation.',
      'medium' => 'Moderate stress ($score/100). Take breaks.',
      _ => '✅ Low stress ($score/100). Keep it up!',
    };
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(
            riskLevel == 'high' ? Icons.warning_amber_rounded : Icons.info_outline,
